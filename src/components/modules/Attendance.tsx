...
const Attendance: React.FC<AttendanceProps> = ({ userType }) => {
  ...
  const [newAttendance, setNewAttendance] = useState({ date: '', status: 'Present' as 'Present' | 'Absent' });
        ...
        <div>
          ...
          <form onSubmit={handleAddAttendance} className="flex space-x-2 mb-4">
            ...
            <select
              ...
              onChange={(e) => setNewAttendance({ ...newAttendance, status: e.target.value as 'Present' | 'Absent' })}
